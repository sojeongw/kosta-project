        ...
        <div id="main" class="col-sm-offset-3 col-sm-9">
          <div class="card" id="pie-charts">
            <div class="card-block">
              ...
              <div class="round-chart" data-percent="${((run_kcal+bicycle_kcal+rope_kcal)/goal)*100}">
                <span>
            	<fmt:formatNumber value="${((run_kcal+bicycle_kcal+rope_kcal)/ goal)*100}" maxFractionDigits="2"></fmt:formatNumber>

                  <small>
                    % <br>
                  	 KCAL <fmt:formatNumber value="${((run_kcal+bicycle_kcal+rope_kcal))}" maxFractionDigits="2"></fmt:formatNumber>kcal
                  </small>
                </span>
              </div>
          ...
          <div class="card" id="quick-info">
            <div class="card-block">
              ...
              <div class="quick-stats">
                <strong>Run:</strong>
                <span>${run_kcal}kcal</span>
              </div>
              <div class="quick-stats">
                <strong>Bicycle:</strong>
                <span>${bicycle_kcal}kcal</span>
              </div>
              <div class="quick-stats">
                <strong>Rope:</strong>
                <span>${rope_kcal}kcal</span>
              </div>
              <div class="quick-stats">
                <strong>Total:</strong>
                <span><fmt:formatNumber value="${((run_kcal+bicycle_kcal+rope_kcal))}" maxFractionDigits="2"></fmt:formatNumber>kcal</span>
              </div>
            </div>
          </div>
        </div>
