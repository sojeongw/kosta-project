...
<body>
	...
	<section>
		...
		menu<input type="text" name="menu" value="ddeok bok ki"><br/>
		price<input type="number" name="price" value="3000"><br/>
		store<input type="text" name="store" value="kim's heaven"><br/>
		kcal<input type="num" name="kcal" value="450"><br/>
